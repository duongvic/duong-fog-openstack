module Fog
  module OpenStack
    class Network
      class Real
        def add_router_interface_fixed_ip(router_id, port_id_or_options)
          if port_id_or_options.kind_of? String
            data = {
              'port_id' => port_id_or_options,
            }
          elsif port_id_or_options.kind_of? Hash
            data = port_id_or_options
          else
      ...
      class Mock
        def add_router_interface_fixed_ip(_router_id, _port_id, _options = {})
